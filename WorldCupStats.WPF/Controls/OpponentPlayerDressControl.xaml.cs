...
{
    public partial class OpponentPlayerDressControl : UserControl
    {
        public static readonly DependencyProperty PlayerNameProperty =
            DependencyProperty.Register("PlayerName", typeof(string), typeof(OpponentPlayerDressControl),
                new PropertyMetadata(string.Empty, OnPlayerNameChanged));

        public static readonly DependencyProperty FirstNameProperty =
            DependencyProperty.Register("FirstName", typeof(string), typeof(OpponentPlayerDressControl),
                new PropertyMetadata(string.Empty));

        public static readonly DependencyProperty LastNameProperty =
            DependencyProperty.Register("LastName", typeof(string), typeof(OpponentPlayerDressControl),
                new PropertyMetadata(string.Empty));

        public static readonly DependencyProperty ShirtNumberProperty =
            DependencyProperty.Register("ShirtNumber", typeof(int), typeof(OpponentPlayerDressControl),
                new PropertyMetadata(0));

        public static readonly DependencyProperty PhotoUrlProperty =
            DependencyProperty.Register("PhotoUrl", typeof(string), typeof(OpponentPlayerDressControl),
        ...
        public static readonly DependencyProperty PictureFileNameProperty =
            DependencyProperty.Register("PictureFileName", typeof(string), typeof(OpponentPlayerDressControl),
                new PropertyMetadata(null, OnPictureFileNameChanged));

        public static readonly DependencyProperty PositionProperty =
            DependencyProperty.Register("Position", typeof(Position), typeof(OpponentPlayerDressControl),
        ...
        {
            if (d is OpponentPlayerDressControl control && e.NewValue is string fullName)
            {
        ...
        {
            if (d is OpponentPlayerDressControl control)
            {
                try
                {
        ...
        public OpponentPlayerDressControl()
        {
            InitializeComponent();
            ...
            this.MouseLeftButtonDown += OpponentPlayerDressControl_MouseLeftButtonDown;
        }

        private void OpponentPlayerDressControl_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
